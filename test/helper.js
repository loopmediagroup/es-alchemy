...
export const mappingsExclude = Index.loadJsonInDir(path.join(fs.dirname(import.meta.url), 'mappings-exclude'));
export const fields = Index.loadJsonInDir(path.join(fs.dirname(import.meta.url), 'fields'));
export const fieldsExclude = Index.loadJsonInDir(path.join(fs.dirname(import.meta.url), 'fields-exclude'));
